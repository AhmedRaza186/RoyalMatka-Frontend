...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-brand-gold/15 bg-brand-charcoal pt-16 pb-8 text-neutral-light">
      {/* Decorative background radial pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(#2d2724_1px,transparent_1px)] [background-size:32px_32px] opacity-[0.04] pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12">
          ...
          <div className="space-y-5">
            <Link href="/" className="flex items-center gap-3 group w-fit">
              ...
              <div className="flex flex-col justify-center leading-none">
                <span className="font-serif text-lg font-bold tracking-wide text-brand-cream transition-colors duration-300 group-hover:text-brand-gold">
                  ROYAL MATKA
                </span>
            ...
            <p className="font-sans text-xs sm:text-sm leading-6 text-neutral-muted">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-brand-gold/15 bg-brand-charcoal text-brand-gold transition-all duration-300 hover:border-brand-gold hover:bg-brand-gold hover:text-brand-charcoal hover:-translate-y-0.5"
              >
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 font-sans text-xs sm:text-sm">
              <li>
                <Link
                  href="#home"
                  className="text-neutral-muted hover:text-brand-gold transition-colors duration-300 relative py-1 group block w-fit"
                >
                  Home
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4 font-sans text-xs sm:text-sm text-neutral-muted">
              <div>
                <h4 className="font-bold text-brand-cream uppercase text-[10px] tracking-widest mb-1">
                  Visit Us
                </h4>
        ...
        {/* Bottom Bar Section */}
        <div className="mt-16 border-t border-brand-gold/15 pt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between font-sans text-xs text-neutral-muted text-center sm:text-left">
