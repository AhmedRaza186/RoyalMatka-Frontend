...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(#2d2724_1px,transparent_1px)] [background-size:24px_24px] opacity-10 pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            {/* Main Headline */}
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-cream leading-[1.1] tracking-wide max-w-2xl">
            ...
            {/* Supporting Copy */}
            <p className="text-neutral-muted text-base sm:text-lg leading-relaxed max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center lg:justify-start">
              ...
              <Link
                href="#menu"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-brand-gold rounded-full text-sm font-bold uppercase tracking-wider text-brand-cream hover:bg-brand-gold hover:text-brand-charcoal transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0"
              >
                Explore Menu
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 relative h-[380px] sm:h-[450px] lg:h-[500px] w-full flex items-center justify-center">
            ...
            <div className="absolute z-20 w-[240px] h-[240px] sm:w-[300px] sm:h-[300px] rounded-full overflow-hidden border-4 border-brand-gold shadow-2xl transition-all duration-500 hover:scale-105 group bg-[#161311]">
              <Image
                ...
                priority
              />
              <div className="absolute inset-0 bg-gradient-to-t from-brand-charcoal/80 via-brand-charcoal/10 to-transparent opacity-80"></div>
              <div className="absolute bottom-4 left-0 right-0 text-center px-4">
                ...
                <h3 className="font-serif text-brand-cream text-sm sm:text-base font-semibold mt-1.5 drop-shadow-md">
            ...
            <div className="absolute z-10 -left-4 sm:left-4 bottom-2 sm:bottom-6 w-[130px] h-[130px] sm:w-[170px] sm:h-[170px] rounded-full overflow-hidden border-2 border-brand-gold/40 shadow-xl hover:scale-105 hover:z-30 transition-all duration-300 bg-[#161311]">
              <Image
              ...
              <div className="absolute bottom-3 left-0 right-0 text-center px-2">
                <h4 className="font-serif text-brand-cream text-[10px] sm:text-xs font-semibold">
                  Beef Matka
                </h4>
              </div>
            </div>
            ...
            <div className="absolute z-10 -right-4 sm:right-4 top-2 sm:top-6 w-[130px] h-[130px] sm:w-[170px] sm:h-[170px] rounded-full overflow-hidden border-2 border-brand-gold/40 shadow-xl hover:scale-105 hover:z-30 transition-all duration-300 bg-[#161311]">
              <Image
