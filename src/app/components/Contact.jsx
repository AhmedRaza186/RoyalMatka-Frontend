...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-bg-base py-20 md:py-28 border-t border-border-base transition-colors duration-300"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-start">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            {/* Visit Us Card */}
            <div className="rounded-2xl border border-border-base bg-surface-base/50 p-6 shadow-lg hover:border-border-active transition-all duration-300">
              ...
              <h3 className="font-serif text-lg font-bold text-text-base">Visit Us</h3>
              <p className="mt-2 font-sans text-xs sm:text-sm text-brand-gold/90 font-medium">Royal Matka Biryani</p>
              <address className="mt-1 not-italic font-sans text-xs sm:text-sm leading-5 text-text-muted">
            ...
            <div className="rounded-2xl border border-border-base bg-surface-base/50 p-6 shadow-lg hover:border-border-active transition-all duration-300">
              ...
              <h3 className="font-serif text-lg font-bold text-text-base">Call Us</h3>
              <p className="mt-2 font-sans text-xs sm:text-sm text-text-muted">For phone orders and queries:</p>
              <a
            ...
            <div className="rounded-2xl border border-border-base bg-surface-base/50 p-6 shadow-lg hover:border-border-active transition-all duration-300">
              ...
              <h3 className="font-serif text-lg font-bold text-text-base">WhatsApp</h3>
              <p className="mt-2 font-sans text-xs sm:text-sm text-text-muted">Order directly on WhatsApp:</p>
              <a
            ...
            <div className="rounded-2xl border border-border-base bg-surface-base/50 p-6 shadow-lg hover:border-border-active transition-all duration-300">
              ...
              <h3 className="font-serif text-lg font-bold text-text-base">Opening Hours</h3>
              <p className="mt-2 font-sans text-xs sm:text-sm text-text-muted">We serve hot biryani during:</p>
          ...
          <div className="rounded-3xl border border-border-base bg-surface-base/60 p-8 sm:p-10 shadow-2xl relative">
            ...
            {isSubmitted ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h3 className="font-serif text-2xl font-bold text-text-base">Enquiry Received</h3>
                <p className="mt-3 font-sans text-sm text-text-muted max-w-sm">
                  Thank you for getting in touch. A representative from Royal Matka Biryani will contact you shortly.
                </p>
                <button
                  onClick={() => setIsSubmitted(false)}
                  className="mt-8 rounded-full border border-brand-gold/45 text-brand-gold hover:bg-brand-gold hover:text-bg-base px-6 py-2.5 font-sans text-xs font-bold uppercase tracking-wider transition-all duration-300 cursor-pointer"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-border-base bg-bg-base px-4 py-3 font-sans text-sm text-text-base placeholder-text-muted/50 focus:border-brand-gold focus:ring-1 focus:ring-brand-gold/30 focus:outline-none transition-all"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="font-sans text-xs font-bold uppercase tracking-wider text-brand-gold block">
                      Email Address <span className="text-text-muted/60 font-normal">(Optional)</span>
                    </label>
                    <input
                      type="email"
                      id="email"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-lg border border-border-base bg-bg-base px-4 py-3 font-sans text-sm text-text-base placeholder-text-muted/50 focus:border-brand-gold focus:ring-1 focus:ring-brand-gold/30 focus:outline-none transition-all resize-none"
                  ></textarea>
                </div>
            ...
            <div className="mt-8 pt-6 border-t border-border-base/50 flex items-center justify-center gap-2 text-xs">
              <span className="font-sans text-text-muted">Prefer WhatsApp?</span>
              <a
